...
<body style="width: 60%; height: 100%;">
	<div
		style="top: 30%; right: 30%; left: 37%; position: absolute; background: #F6F6F2">
		<div style="margin: 20px 20px">
			<h1>Welcome ! Fitness Monitor WebApp</h1>
			<form action="MonitorNow.jsp" method="get">
				...
				<h3>
					<input type="radio" checked name="choice"
						value="intput performance">Input Work out Performance <input
						type="radio" name="choice" value="history">History
					Statistics in past week <br> <br>
				</h3>
